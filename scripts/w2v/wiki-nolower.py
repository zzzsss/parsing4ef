...
def tokenize(content):
    ...
    return [token.encode('utf8') for token in utils.tokenize(content, lower=False, errors='ignore')  ## !! no lower
...
## this is a copy of gensim.corpora.wikicorpus.py, but no lower ##
import logging
import os.path
import sys
...
if __name__ == '__main__':
    ...
    output = open(outp, 'w')
    wiki = WikiCorpus2(inp, lemmatize=False, dictionary={}, processes=2)
